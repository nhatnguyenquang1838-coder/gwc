# G3 Offline Skill Library

This directory is the deterministic offline fallback for GWC G3 review guidance.
...
The cards are GWC-normalized offline adaptations. They do not override protected-base governance and do not grant G4 merge authority.
