...
- Make the minimum autonomous control-plane protection set validator-enforced and non-configurable, including all GitHub workflows, repo instructions, Node Architect runtime contracts/schemas/tools, standing-policy surfaces and G4/G5 authority controls.
