...
def decide_g3_pass(
    ...
    *,
    ...
    """Evaluate exact-head G3 prerequisites without granting G4 authority."""
    ...
    if replay_cache is not None and cache_key and cache_key in replay_cache:
        ...
        return {
            ...
            **identity,
            "outcome": G3_BLOCKED,
            "reason_codes": ["EVIDENCE_REJECTED", "G3_BLOCKED"],
    ...
    for validation in validations:
        ...
        if status in {"PENDING", "WAIT", "UNKNOWN", "UNAVAILABLE"}:
    ...
    for finding in findings:
        ...
        if severity == "BLOCKER":
            reasons.add("UNRESOLVED_BLOCKER")
        elif severity == "MAJOR" and finding.get("risk_acceptance") is not True:
            reasons.add("UNRESOLVED_BLOCKER")
    ...
    result = {
        ...
        **identity,
        ...
        "transition_effect_applied": outcome == G3_PASS,
        "replayed": False,
        **_authority_boundary(),
    }
