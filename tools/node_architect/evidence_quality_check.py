...
def check_evidence_quality(
    ...
    *,
    ...
    terminal_conclusions = {
        str(value).lower()
        for value in payload.get("terminal_ci_conclusions", [])
        if str(value).strip()
    }
    ...
    quality_basis = {
        ...
        "ci_evidence_digest": ci.get("evidence_digest"),
        "review_receipt_digest": review.get("receipt_digest") or _digest(dict(review)),
    }
    result = {
        "schema_version": "1.0",
        "artifact_type": "evidence-quality-decision",
