#!/usr/bin/env python3
"""Validate the validation_quality controlled node catalog family."""
...
REQUIRED_COUNT = 9
FAMILY_PREFIX = "validation-quality-"
...
def validate_family(family_dir: Path) -> None:
    ...
    for path in node_files:
        ...
        expected_id = FAMILY_PREFIX + path.name.removesuffix(".node.json")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--family-dir", type=Path, default=Path("core/node-architect/node-catalog/validation_quality"))
    ...
    try:
        ...
        return 1
    print("PASS: validation_quality node catalog family is valid")
    return 0
