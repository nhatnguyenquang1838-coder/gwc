...
RUNTIME_CONTRACTS={
 ...
 "intake_context.files-write-scope": {"schema": "schemas/bounded-write-scope.schema.json", "evaluator": "tools/node_architect/files_write_scope.py", "entrypoint": "render_files_write_scope", "artifact_type": "bounded-write-scope"},
