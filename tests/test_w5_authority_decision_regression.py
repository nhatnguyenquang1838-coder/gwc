...
class PlanBoundAuthorityDecisionRegressionTest(unittest.TestCase):
    def test_require_approval_never_counts_as_revalidated_execution_authority(self) -> None:
        ...
        with patch(
            "tools.node_architect.authority_boundary_check.check_authority_boundary",
