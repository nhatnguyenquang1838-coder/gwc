...
MANIFEST = ROOT / "libs" / "g0-g1-skill-library" / "manifest.yaml"


class G0G1OfflineSkillLibraryTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.manifest = yaml.safe_load(MANIFEST.read_text(encoding="utf-8"))

    def test_library_metadata(self) -> None:
        self.assertEqual("gwc-g0-g1-offline-skills", self.manifest["library_id"])

    def test_bundle_atomic_fallback_policy(self) -> None:
