...
class TestFamilyFlow(unittest.TestCase):
    ...
    def test_191_envelope_awaiting_then_190_transition(self):
        env = render_g2_execution_envelope(
            ...
            gate_state_resolution={"gate_status": "PASS",
                                   "drift_decision": {"status": "NO_DRIFT", "reason_codes": []},
                                   "replay_status": "FIRST_SEEN",
                                   "reason_codes": ["GATE_STATE_RESOLVED",
            ...
            evidence_map={"outcome": "READY", "reason_codes": ["EVIDENCE_MAP_READY"],
                          "missing_required": [], "stale_required": [],
                          "projection_only": [],
                          "f1_artifact_digests": {"g0": "sha256:" + "e" * 64}},
