# SCRUM-203 Fastlane G2 R3 handoff
...
- Approval: `CP-20260730-203-G2-R3`
- Scope hash: `sha256:8ab19301ea8de65c0d1d911708e14dd13d1f5d11d49f4b89c1071cbd2d57c332`
...
this handoff, and .gwc/tasks/SCRUM-203/g2/execution-envelope.yaml.

Before implementation, re-read current main. Continue only if main is still:
3b0938065e71e699d327d041f5b6023ed30a29dc

Materialize task-scoped G0/G1/G2 under .gwc/tasks/SCRUM-203, run:
python tools/validate_g01.py --workspace .gwc/tasks/SCRUM-203 --gate G2_EXECUTION --json

Require PASS. Then implement only approved paths for checkpoint-persist, validate CAS, event append,
idempotent replay, and duplicate-effect prevention. Push guarded branch and stop at G2 exit.
